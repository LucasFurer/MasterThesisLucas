...
//{
//    double* P = nullptr; // old P matrix, not used anymore
//
...
//    ParticleMeshData() {}
//
//    ParticleMeshData(Eigen::SparseMatrix<double>& Pmatrix, std::vector<TsnePoint2D>& points, int init_n_interpolation_points, double init_intervals_per_integer, int init_min_num_intervals)
//    {
//        //std::cout << "start making the mesh data" << std::endl;
//
//        N = points.size();
//
...
//        //std::cout << "made P matrices with size: " << Pmatrix.nonZeros() << std::endl;
...
//    }
//
//    ParticleMeshData(const ParticleMeshData& other) // copy constructor
//    {
//        P = other.P;
//        N = other.N;
//        D = other.D;
...
//    }
//
//    ParticleMeshData& operator=(const ParticleMeshData& other) // copy assignment operator
//    {
