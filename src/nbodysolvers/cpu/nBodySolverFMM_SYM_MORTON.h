...
void TSNEFMM_SYM_MORTONNNKernel(float& total, NodeFMM_MORTON_2D& sinkNode, NodeFMM_MORTON_2D& sourceNode)
{
...
void TSNEFMM_SYM_MORTONPNKernel(float& total, TsnePoint2D& sinkPoint, NodeFMM_MORTON_2D& sourceNode)
{
...
void TSNEFMM_SYM_MORTONNPKernel(float& total, NodeFMM_MORTON_2D& sinkNode, TsnePoint2D& sourcePoint)
{
...
void TSNEFMM_SYM_MORTONPPKernel(float& total, TsnePoint2D& sinkPoint, TsnePoint2D& sourcePoint)
{
